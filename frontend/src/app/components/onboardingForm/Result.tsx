...
const Result = ({ onReset } : ResultProps) => {
  ...
  return (
    <div>
      ...
      <p><strong>Professional Title:</strong> {state.data.professionalTitle}</p>
      <p><strong>Country:</strong> {state.data.country}</p>
      <p><strong>Field1:</strong> {state.data.field1}</p>
