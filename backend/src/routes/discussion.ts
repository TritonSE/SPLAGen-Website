...
router.delete('/', DiscussionValidator.deleteMultipleDiscussions, DiscussionController.deleteMultipleDiscussions);
router.get('/', DiscussionValidator.getMultipleDiscussions, DiscussionController.getMultipleDiscussions);
